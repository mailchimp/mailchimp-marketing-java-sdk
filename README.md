...
```groovy
dependencies {
  implementation 'com.mailchimp:mailchimp-marketing:0.0.215'
}
```
...
A full reference for this library is available [here](https://github.com/mailchimp/mailchimp-marketing-java-sdk/blob/HEAD/./reference.md).
...
```java
import com.mailchimp.marketing.MailchimpClient;
import com.mailchimp.marketing.core.Environment;
...
```java
MailchimpClientHttpResponse response = client.accountExports().withRawResponse().create(...);
