...
import com.mailchimp.marketing.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncMailchimpClientBuilder {
     ...
     * Sets token
     */
    public AsyncMailchimpClientBuilder token(String token) {
        this.token = token;
        return this;
    }

    public AsyncMailchimpClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncMailchimpClientBuilder url(String url) {
     ...
     */
    public AsyncMailchimpClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncMailchimpClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncMailchimpClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public AsyncMailchimpClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public AsyncMailchimpClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public AsyncMailchimpClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncMailchimpClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncMailchimpClientBuilder addHeader(String name, String value) {
        this.customHeaders.put(name, value);
        return this;
    }

    public AsyncMailchimpClientBuilder serverPrefix(String serverPrefix) {
    ...
    public AsyncMailchimpClient build() {
        if (token == null) {
            throw new RuntimeException("Please provide token");
        }
        validateConfiguration();
        return new AsyncMailchimpClient(buildClientOptions());
    }
}
