...
public class MailchimpClientBuilder {
     ...
     * Sets token
     */
    public MailchimpClientBuilder token(String token) {
        this.token = token;
        return this;
    }

    public MailchimpClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public MailchimpClientBuilder url(String url) {
     ...
     */
    public MailchimpClientBuilder timeout(int timeout) {
     ...
     */
    public MailchimpClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public MailchimpClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public MailchimpClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public MailchimpClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public MailchimpClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public MailchimpClientBuilder logging(LogConfig logging) {
     ...
     */
    public MailchimpClientBuilder addHeader(String name, String value) {
    ...
    public MailchimpClient build() {
        ...
        return new MailchimpClient(buildClientOptions());
    }
}
